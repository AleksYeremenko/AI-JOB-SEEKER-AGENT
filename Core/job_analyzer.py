...
class JobAnalyzer:
    ...
    def generate_ats_resume(self, title, company, details, job_lang):
        prompt = (
            ...
            f"2. КРИТИЧЕСКИ ВАЖНО ДЛЯ ATS: Используй ТОЧНО ТАКИЕ ЖЕ термины и названия технологий, как в описании вакансии. Совпадение должно быть посимвольным. Если в вакансии написано 'React.js', ты ДОЛЖЕН писать 'React.js', а не 'React' или 'ReactJS'. Это критично для автоматических фильтров.\n"
